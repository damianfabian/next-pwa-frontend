...
export default class Router {
    ...
    private _ignoredcontainers: RegExp | undefined;
    ...
    set ignoredcontainers(ignoredcontainers: RegExp) {
        this._ignoredcontainers = ignoredcontainers;
    }
    ...
    handleFetch = async (event: FetchEvent): Promise<void> => {
        ...
        if (this._ignoredcontainers && this._ignoredcontainers.test(url)) {
            return;
        }
